...
function Agenda() {
    return (
        <section id='agenda' lassName="mb-36"  >
                    ...
                    >
                        {data.map((item) => (
                            <div key={item.id}        className='  w-[200px] inline-block p-2 cursor-pointer hover:scale-105 ease-in-out duration-300'    >
                                <div className=' absolute top-0 text-center  font-bold   text-2xl uppercase ml-6 '>{item.hour}   </div>
                                <div className={`  text-center w-[160px] absolute top-[50px]   bg-gradient-to-r rounded-sm  font-bold text-2xl from   from-blue-500 to-green-500 `}>{item.events[0].day1}</div>
                                <div className={`p-1 absolute w-[160px] top-[100px]  bg-gradient-to-r rounded-sm  font-bold text-2xl from  from-blue-500 to-green-500`}>{item.events[0].day2}</div>
                                <div className={`p-1 absolute w-[160px] top-[150px]  bg-gradient-to-r rounded-sm  font-bold text-2xl from-blue-500 to-green-500`}>{item.events[0].day3}</div>
                            </div>
